...
export function createSysAlert(msg) {
...
export function createUsrImg(dataUrl, usrId) {
...
export function createPeerImg(dataUrl, usrId) {
...
export function createUsrMsg(msg, usrId) {
...
export function createPeerMsg(msg, usrId) {
...
export function SendUsrName(newName) {
...
export function processData(data) {
    ...
    switch (dataType) {
        case "text":
            createPeerMsg(data.replace(newUserId + ":", "").replace(dataType + "/", ""), msg_smod.peerUsername);
            msg_logmod.log(local_function_tag, "Recieved data from " + msg_smod.peerUsername);
            msg_smod.setIsTyping(false);
            break;
        case "img":
            createPeerImg(data.replace(newUserId + ":", "").replace(dataType + "/", ""), msg_smod.peerUsername);
            msg_smod.setIsTyping(false);
            break;
        case "name":
