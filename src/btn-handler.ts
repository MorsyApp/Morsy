...
export const messageBox: HTMLInputElement | null =
  document.querySelector(".message-box");
export const messageContainer: HTMLDivElement | null =
  document.querySelector(".message-container");
export const fileBtn: SVGSVGElement | null =
  document.querySelector(".file-btn");
export const fileInp: HTMLInputElement | null =
  document.querySelector(".file-input");
export const usernameInp: HTMLInputElement | null =
  document.querySelector(".username-inp");
export const editNameBtn: HTMLAnchorElement | null =
  document.querySelector(".edit-name-btn");
export const inviteLinkBox: HTMLInputElement | null =
  document.querySelector(".invite-link-box");
export const copyInviteBtn: HTMLDivElement | null =
  document.querySelector(".copy-invite-btn");
export const inviteCloseBtn: SVGSVGElement | null =
  document.querySelector(".invite-close-btn");
export const invitePopup: HTMLDivElement | null =
  document.querySelector(".invite-popup");
export const inviteBtn: HTMLAnchorElement | null =
  document.querySelector(".invite-btn");
export const typingMsg: HTMLHeadingElement | null =
  document.querySelector(".is-typing-msg");
export const rootElmnt: any = document.querySelector(":root");
export const trippleDotMenu: SVGSVGElement | null =
  document.querySelector(".tripple-dot-menu");
export const menuBtnContainer: HTMLDivElement | null = document.querySelector(
  ".menu-btn-container"
);
if (inviteLinkBox) inviteLinkBox.value = window.location.href;

export let colorMode: string = "";
export let menuBtnContainerHover: boolean;
...
if (editNameBtn) {
  ...
  editNameBtn.addEventListener("click", () => {
    if (!btn_scrmod.editingName) {
      if (editNameBtn) editNameBtn.innerHTML = "Save";
